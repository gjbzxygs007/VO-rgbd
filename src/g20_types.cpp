...
namespace slamrgbd {
    ...
    void EdgeProjectXYZ2UVPoseOnly::computeError()
    {
        ...
        _error = _measurement - camera_->CameraToPixel(
    ...
    void EdgeProjectXYZ2UVPoseOnly::linearizeOplus()
    {
        ...
        _jacobianOplusXi ( 0,0 ) =  x*y/z_2 *camera_->GetFx();
        _jacobianOplusXi ( 0,1 ) = - ( 1+ ( x*x/z_2 ) ) *camera_->GetFx();
        _jacobianOplusXi ( 0,2 ) = y/z * camera_->GetFx();
        _jacobianOplusXi ( 0,3 ) = -1./z * camera_->GetFx();
        _jacobianOplusXi ( 0,4 ) = 0;
        _jacobianOplusXi ( 0,5 ) = x/z_2 * camera_->GetFx();

        _jacobianOplusXi ( 1,0 ) = ( 1+y*y/z_2 ) *camera_->GetFy();
        _jacobianOplusXi ( 1,1 ) = -x*y/z_2 *camera_->GetFy();
        _jacobianOplusXi ( 1,2 ) = -x/z *camera_->GetFy();
        _jacobianOplusXi ( 1,3 ) = 0;
        _jacobianOplusXi ( 1,4 ) = -1./z *camera_->GetFy();
        _jacobianOplusXi ( 1,5 ) = y/z_2 *camera_->GetFy();
    }
